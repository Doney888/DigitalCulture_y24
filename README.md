...
### Задание 6: 
- **Условие**: 
[ Посчитайте количество телефонных номеров в формате E.164 в данном файле. Номера могут начинаться или не начинаться со знака «+», не могут начинаться с 0 (в том числе после знака «+») и содержат от 2 до 15 цифр.
